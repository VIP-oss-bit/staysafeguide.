---
title: "iPhone privacy settings: the ones worth changing (a soft guide)"
...
<!-- TODO (Iulian): a screenshot of the Tracking or Location Services screen on your own iPhone would add a nice personal touch. -->
...
<p><strong>If you only do three things:</strong> turn off "Allow Apps to Request to Track", set app locations to "While Using", and switch on Safari's cross-site tracking protection.</p>
</div>
...
On Android as well, or someone in the family is? See our [Android privacy guide](/articles/android-privacy-settings/), and for the wider view read our [simple guide to protecting your privacy online](/articles/online-privacy-guide/). More in our [privacy section](/topics/vpns-privacy/).
