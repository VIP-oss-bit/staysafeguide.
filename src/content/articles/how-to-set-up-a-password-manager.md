---
title: "How to set up a password manager (a simple walkthrough)"
...
<p><strong>Quick win:</strong> do your email account today. It's the one that can reset all your others, so it deserves a strong, unique password and 2FA before anything else.</p>
</div>

Worried a manager isn't safe? Read [are password managers safe?](/articles/are-password-managers-safe/) first. And check whether your current passwords have already leaked: [how to check if your password has been leaked](/articles/how-to-check-if-your-password-has-been-leaked/).
