---
title: "Two-factor authentication (2FA): what it is and how to switch it on"
...
<p><strong>Worth knowing:</strong> many password managers can store your 2FA codes next to your logins, which makes signing in quick. Keeping them in the same place as your passwords trades a little separation for a lot of convenience, and it is still far safer than having no 2FA at all.</p>
</div>

Pair this with the basics and you are ahead of almost everyone: a [password manager](/articles/how-to-set-up-a-password-manager/), [strong unique passwords](/articles/how-to-create-a-strong-password/), and a quick [check for any leaked logins](/articles/how-to-check-if-your-password-has-been-leaked/). More in our [password section](/topics/password-managers/).
