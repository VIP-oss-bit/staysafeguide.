---
title: "Android privacy settings: a soft, no-stress guide to locking things down"
...
Your phone knows a lot about you: where you go, what you do, who you talk to. The good news is that Android gives you real control over this, and you only need to change a handful of settings to make a big difference. Take it one section at a time.

<!-- TODO (Iulian): a screenshot from your own Android of the Permission manager or Location screen would make this much stronger. -->
...
<p><strong>If you only do three things:</strong> set app locations to "while using", run through the camera and microphone permissions, and turn on auto-delete for your Google activity. That covers most of it.</p>
</div>
...
Got an iPhone too, or in the family? See our [iPhone privacy guide](/articles/iphone-privacy-settings/), and for the bigger picture start with our [simple guide to protecting your privacy online](/articles/online-privacy-guide/). More in our [privacy section](/topics/vpns-privacy/).
