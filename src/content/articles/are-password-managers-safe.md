---
title: "Are password managers safe? (and why you probably need one)"
...
- **A weak master password.** This is the one key to everything, so it has to be long and unique. See [how to create strong passwords you'll actually remember](/articles/how-to-create-a-strong-password/).
...
- **Phishing.** A fake login page can still trick you into typing your master password. Knowing the signs helps: [how to spot a phishing email](/articles/how-to-spot-a-phishing-email/).
...
<!-- TODO (Iulian): mention which password manager you personally use and why. -->

Ready to start? See [how to set up a password manager](/articles/how-to-set-up-a-password-manager/), and check whether your details are already exposed with [how to check if your password has been leaked](/articles/how-to-check-if-your-password-has-been-leaked/). More in our [password section](/topics/password-managers/).
