---
title: "How to create strong passwords you'll actually remember"
...
Here's the thing the experts actually do. You only need to *remember* two or three passwords: the one for your password manager, and maybe your email and device. For everything else, let your [password manager](/articles/how-to-set-up-a-password-manager/) generate long, random passwords and remember them for you. You get a unique, uncrackable password on every account without memorising any of them.

<div class="callout tip">
<p><strong>The short version:</strong> use three random words for the few passwords you must remember, let a password manager handle the rest, never reuse a password, and turn on two-factor authentication on your important accounts.</p>
</div>

Not sure a manager is safe? See [are password managers safe?](/articles/are-password-managers-safe/) Want to know if your current passwords have already leaked? Try [how to check if your password has been leaked](/articles/how-to-check-if-your-password-has-been-leaked/). More in our [password section](/topics/password-managers/).
