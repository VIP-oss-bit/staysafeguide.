---
title: "How to spot a phishing email (with the red flags that give it away)"
...
<!-- TODO (Iulian): drop in a screenshot from your home lab or inbox of a real phishing email with the red flags circled. That single image will set this page apart. -->
...
<p><strong>A password manager quietly protects you here.</strong> It only fills in your login on the genuine web address it has saved. So if a phishing page is pretending to be your bank, the manager will not autofill, and that silence is a useful warning. See our <a href="/topics/password-managers/">password guides</a>.</p>
</div>
...
If you think you have lost money or handed over bank details, read [what to do if you've been scammed](/articles/what-to-do-if-youve-been-scammed-uk/) and act quickly. More in our [scams and fraud section](/topics/scams-fraud/).
